...
bool AboutUs::init()
{
	...
	Sprite* background = Sprite::create("aboutUsBack.png");
	background->setPosition(visibleSize.width / 2, visibleSize.height / 2);
	addChild(background, 0);


	back = MenuItemImage::create("selGod.png", "selGod.png", CC_CALLBACK_1(AboutUs::onBack, this));
